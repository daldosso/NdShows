    ...
    private class DetailRowBuilderTask extends AsyncTask<Movie, Integer, DetailsOverviewRow> {
        ...
        protected DetailsOverviewRow doInBackground(Movie... movies) {
            ...
            row.addAction(new Action(ACTION_WATCH_TRAILER, getResources().getString(
                    com.adaldosso.ndshows.R.string.watch_trailer_1), getResources().getString(com.adaldosso.ndshows.R.string.watch_trailer_2)));
            row.addAction(new Action(ACTION_RENT, getResources().getString(com.adaldosso.ndshows.R.string.rent_1),
                    getResources().getString(com.adaldosso.ndshows.R.string.rent_2)));
            row.addAction(new Action(ACTION_BUY, getResources().getString(com.adaldosso.ndshows.R.string.buy_1),
                    getResources().getString(com.adaldosso.ndshows.R.string.buy_2)));
            return row;
        }
        ...
        protected void onPostExecute(DetailsOverviewRow detailRow) {
            ...
            mDorPresenter.setBackgroundColor(getResources().getColor(com.adaldosso.ndshows.R.color.detail_background));
            ...
            mDorPresenter.setOnActionClickedListener(new OnActionClickedListener() {
                ...
                public void onActionClicked(Action action) {
                    if (action.getId() == ACTION_WATCH_TRAILER) {
                        ...
                        intent.putExtra(getResources().getString(com.adaldosso.ndshows.R.string.movie), mSelectedMovie);
                        intent.putExtra(getResources().getString(com.adaldosso.ndshows.R.string.should_start), true);
            ...
            String subcategories[] = {
                    getString(com.adaldosso.ndshows.R.string.related_movies)
            };
