...
public class PlaybackOverlayActivity extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.adaldosso.ndshows.R.layout.playback_controls);
        loadViews();
        //setupCallbacks();
        overScan();
    }
    ...
    private void loadViews() {
        mVideoView = (VideoView) findViewById(com.adaldosso.ndshows.R.id.videoView);
    }
        ...
        mVideoView.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mp, int what, int extra) {
                ...
                if (extra == MediaPlayer.MEDIA_ERROR_TIMED_OUT) {
                    msg = getString(com.adaldosso.ndshows.R.string.video_error_media_load_timeout);
                } else if (what == MediaPlayer.MEDIA_ERROR_SERVER_DIED) {
                    msg = getString(com.adaldosso.ndshows.R.string.video_error_server_inaccessible);
                } else {
                    msg = getString(com.adaldosso.ndshows.R.string.video_error_unknown_error);
                }
